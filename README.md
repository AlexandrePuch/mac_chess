...
```bash
git clone https://github.com/JohnDoe/mac_chess.git
cd mac_chess
git remote add upstream https://github.com/Dauphine203/mac_chess.git
```
...
First, be sure you master is up to date; on your remote fork on github (here `JohnDoe/mac_chess`)
you should see `This branch is even with Dauphine203/mac_chess`. If not, you need to update:
